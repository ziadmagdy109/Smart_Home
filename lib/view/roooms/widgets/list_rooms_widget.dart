...
import 'package:smart_home/view/roooms/list_devices.dart';

class ListRoomsWidget extends StatelessWidget {
  ListRoomsWidget({super.key});
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Get.to(()=> ListDevices(image:  room["image"]!));
...
Widget _buildIcon(HeroIcons iconHero) {
  return Container(
    ...
    decoration: BoxDecoration(
      border: Border.all(color: AppColors.myBlack.withOpacity(0.2)),
